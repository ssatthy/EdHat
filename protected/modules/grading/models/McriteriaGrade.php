...
/**
 * This is the model class for table "mcriteria_grade".
 *
 * The followings are the available columns in table 'mcriteria_grade':
 * @property integer $id
 ...
 * @property MeritCriteriaItem $criteria
 * @property CourseWork $cwork
 * @property User $verifier
 */
class McriteriaGrade extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return McriteriaGrade the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'criteria' => array(self::BELONGS_TO, 'MeritCriteriaItem', 'criteria_id'),
