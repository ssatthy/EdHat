...
/**
 * This is the model class for table "pcriteria_grade".
 *
 * The followings are the available columns in table 'pcriteria_grade':
 * @property integer $id
 ...
 * @property PassCriteriaItem $criteria
 * @property CourseWork $cwork
 * @property User $verifier
 */
class PcriteriaGrade extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PcriteriaGrade the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'criteria' => array(self::BELONGS_TO, 'PassCriteriaItem', 'criteria_id'),
