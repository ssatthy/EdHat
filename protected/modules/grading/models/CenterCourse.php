 ...
 */
class CenterCourse extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('centerid, CourseIndex', 'required'),
			array('centerid', 'numerical', 'integerOnly'=>true),
			array('CourseIndex', 'length', 'max'=>253),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('centerid, CourseIndex', 'safe', 'on'=>'search'),
		);
	}
