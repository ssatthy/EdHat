...
<tr>
 ...
 <td><?php echo CHtml::activeLabel($record,$record->title) ?></td>
  <td><?php echo CHtml::activeHiddenField($meritgrade,"[$i]id",array('value'=>$dataitems[$i]->id)) ?></td>
 <td><?php echo CHtml::activeHiddenField($meritgrade,"[$i]criteria_id",array('value'=>$dataitems[$i]->criteria_id)) ?></td>
...
<td><?php echo CHtml::activeTextField($meritgrade,"[$i]page_no",array('value'=>$dataitems[$i]->page_no)) ?>
 <?php echo $form->error($meritgrade,"[$i]page_no"); ?></td>

<td><?php  echo $form->dropDownList($meritgrade,"[$i]grade",array('' => 'Select one','OK'=>'Satisfied','NOK'=>'NotSatisfied'),array('options' => array($dataitems[$i]->grade=>array('selected'=>true)))); ?>
 <?php echo $form->error($meritgrade,"[$i]grade"); ?>

 </td>
<td><?php echo CHtml::activeTextArea($meritgrade,"[$i]feedback",array('value'=>$dataitems[$i]->feedback)) ?>
