...
<tr>
 ...
 <td><?php echo CHtml::activeHiddenField($distngrade,"[$i]criteria_id",array('value'=>$record->id)) ?></td>
...
<td><?php echo CHtml::activeTextField($distngrade,"[$i]page_no") ?>
 <?php echo $form->error($distngrade,"[$i]page_no"); ?></td>

<td><?php echo $form->dropDownList($distngrade,"[$i]grade",array('' => 'Select','OK'=>'Satisfied','NOK'=>'NotSatisfied')); ?>
 <?php echo $form->error($distngrade,"[$i]grade"); ?>

 </td>
<td><?php echo CHtml::activeTextArea($distngrade,"[$i]feedback") ?>
