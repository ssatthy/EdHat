...
<tr>
 ...
 <td><?php echo CHtml::activeHiddenField($passgrade,"[$i]criteria_id",array('value'=>$record->id)) ?></td>
...
<td><?php echo CHtml::activeTextField($passgrade,"[$i]page_no") ?>
 <?php echo $form->error($passgrade,"[$i]page_no"); ?></td>

<td><?php echo $form->dropDownList($passgrade,"[$i]grade",array('OK'=>'Satisfied','NOK'=>'NotSatisfied'),array('prompt'=>'Select one')); ?>
 <?php echo $form->error($passgrade,"[$i]grade"); ?>

 </td>
<td><?php echo CHtml::activeTextArea($passgrade,"[$i]feedback") ?>
